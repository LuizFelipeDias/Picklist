...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT * FROM usuario WHERE prontuario_user = ? AND password_user = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ss', $prontuario, $password);
    $stmt->execute();
...
<body>
    ...
    <form method="POST">
        ...
        <div class="social">
          <div class="go"><a href="criarUsuario.php"><i class="fa-solid fa-user"></i> Criar Usuário</a></div>
        </div>
    </form>
</body>
</html>
